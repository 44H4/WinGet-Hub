...
echo --------------------------------------------------------
echo        Winget Hub Installer - Open Shell
echo --------------------------------------------------------
echo Made by : 44H4
...
if %ERRORLEVEL% EQU 0 (
    echo Open Shell installed successfully.
) else (
    echo Failed to install Open Shell. Please check for errors above.
)
pause
