...
echo --------------------------------------------------------
echo        Winget Hub Installer - Rainmeter
echo --------------------------------------------------------
echo Made by : 44H4
...
if %ERRORLEVEL% EQU 0 (
    echo Rainmeter installed successfully.
) else (
    echo Failed to install Rainmeter. Please check for errors above.
)
pause
